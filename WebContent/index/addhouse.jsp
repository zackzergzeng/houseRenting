    ...
    <div class="vip-right">
     ...
     <form action="addhouse.do" method="post">
     	...
     	<label class="radio-inline">
		  <input type="radio" name="houseClass" id="entireRent" value="1" checked> 整租
		</label>
		<label class="radio-inline">
     	...
     	<label for="inputEmail3" class="col-sm-2 control-label" style="text-align:center">地址</label>
			<div class="col-sm-9">
				<div class="col-sm-12" style="position: relative; padding:0px;">
					<input id="location" name="location" class="form-control" readonly type="text" data-toggle="city-picker">
				</div>
		...
		<div class="form-group col-sm-12">
		  ...
		  <div class="col-sm-9">
		    <input type="text" class="form-control" id="rents" name="rents" placeholder="租金">
		  </div>
		</div>
		<div class="form-group col-sm-12">
		  <label for="inputEmail3" class="col-sm-2 control-label" style="text-align:center">面积</label>
		  <div class="col-sm-9">
		    <input type="text" class="form-control" id="area" name="area" placeholder="面积">
		  </div>
		</div>
		<div class="form-group col-sm-12">
		...
		<div class="form-group col-sm-12">
		  ...
		  <div class="col-sm-9">
		    <input type="text" class="form-control" id="age" name="age" placeholder="楼龄">
		  </div>
		</div>
		<div class="form-group col-sm-12">
		...
		<div class="radio">
			<label for="inputEmail3" class="col-sm-2 control-label" style="text-align:center">标签</label>
		    <div class="col-sm-9">
			    <label class="checkbox-inline">
				  <input type="checkbox" name="housetag" id="1" value="1"> 价格低
				</label>
			</div>
		</div>
		<div class="form-group col-sm-12">
		   ...
		   <div class="col-sm-10">
		      <input id="myFile" type="file" name="myFile" multiple class="fileloading">
		   </div>
		</div>
